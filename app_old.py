"""
BetterPrompt Flask Application Entry Point

This is the main entry point for the BetterPrompt application.
Uses the application factory pattern for better organization and testing.
"""
